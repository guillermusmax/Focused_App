...
//import 'package:focused_app/views/auth/change_password_view.dart';
import 'package:focused_app/views/auth/password_verification_view.dart';
import 'package:google_fonts/google_fonts.dart';

class ForgotCodeView extends StatefulWidget {
  const ForgotCodeView({super.key});

  @override
  State<ForgotCodeView> createState() => _ForgotCodeViewState();
}

class _ForgotCodeViewState extends State<ForgotCodeView> {
                  ...
                  children: [
                    ...
                    GestureDetector(
                      child: Container(
                        ...
                        child: InkWell(
                          onTap: isLoading ? null : _sendForgotPasswordRequest,
                          child: Center(
                            child: isLoading
